                ...
                <div class="bg-white m-2 mt-5">
                    <nav aria-label="breadcrumb ">
                        <ol class="breadcrumb bg-white ">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Edit Daftar User</li>
                        </ol>
                    </nav>
                </div>
                ...
                <div class="card m-2">
                    ...
                    <div class="card-body">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" name="email" class="form-control" aria-label="email" placeholder="" value="<?= $user['email'] ?>">
                            </div>

                            <label for="inputGroupFile01">Nomor Telepon</label>
                            <div class="input-group mb-3">
                                <input type="text" name="no_telp" class="form-control" aria-label="no_telp" placeholder="" value="<?= $user['no_telp'] ?>">
                            </div>

                            <div class="modal-footer">
                                <button type="submit" class="btn btn-info" onclick="Swal.fire({text:'Data User Berhasil Diubah', icon: 'success'})">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
