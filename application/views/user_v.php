        ...
        <div class="row">
            ...
            <div class="col-10" id="utama">
                ...
                <div class="head bg-white p-4 m-2 mt-5">
                    <h3 class="bg-white">Kelola User</h3>
                            ...
                            <div class="modal-body">
                                <form action="<?= base_url() ?>User/add" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="no_telp" id="exampleFormControlInput1" placeholder="ex: 08180219123">
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-success" onclick="Swal.fire({text:'User Berhasil Ditambahkan', icon: 'success'})">Done</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                            ...
                            <?php foreach ($user as $K) : ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="<?= base_url(); ?>User/del/<?= $K['id']; ?>" onclick="return confirm('Apakah Akun User Ini Akan Dihapus?');">
                                            <button type="button" class="btn btn-danger" onclick="Swal.fire({text:'User Berhasil Dihapus', icon: 'success'})">
